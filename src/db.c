...
sh_int		gsn_backstab;
sh_int		gsn_circle;
sh_int		gsn_mountjack;
sh_int		gsn_dodge;
sh_int		gsn_envenom;
sh_int		gsn_detect_hidden;
sh_int		gsn_forest_vision;
sh_int		gsn_hide;
sh_int		gsn_brew;
sh_int		gsn_scribe;
sh_int		gsn_peek;
...
sh_int		gsn_nerve_pinch;
sh_int		gsn_pickpocket;
sh_int		gsn_caltrops;
sh_int		gsn_campfire;
sh_int		gsn_search_water;
sh_int		gsn_bear_call;
sh_int		gsn_ambush;
sh_int		gsn_pillify;
sh_int		gsn_herbal_discern;
sh_int            gsn_fight_pos;
sh_int		gsn_trophy;
sh_int		gsn_wear_leather;
sh_int		gsn_wear_chain;
sh_int		gsn_wear_plate;
sh_int		gsn_battlecry;
sh_int		gsn_drain;
sh_int		gsn_bind;
sh_int		gsn_breakneck;
sh_int		gsn_strangle;
sh_int		gsn_guard;
sh_int		gsn_cutthroat;
...
sh_int		gsn_trammel;
sh_int		gsn_sweep;
sh_int		gsn_flank_attack;
sh_int		gsn_scout;
sh_int		gsn_sleepless_curse;
sh_int		gsn_double_bs;
sh_int		gsn_quiet_movement;
sh_int		gsn_strip;
sh_int		gsn_ray_of_fatigue;
sh_int		gsn_squire_call;
sh_int		gsn_surge;
sh_int		gsn_endure;
sh_int		gsn_serenade;
sh_int		gsn_taunt;
...
sh_int		gsn_trance;
sh_int		gsn_mend;
sh_int		gsn_repair_shield;
sh_int		gsn_leather_repair;
sh_int		gsn_plate_repair;
sh_int		gsn_chain_repair;
sh_int		gsn_weapon_repair;
sh_int		gsn_deathblade;
sh_int		gsn_flameblade;
sh_int		gsn_runeblade;
sh_int		gsn_fast_working;
sh_int		gsn_stainless;
sh_int		gsn_eversharp;
sh_int		gsn_purifying_fire;
sh_int		gsn_fletching;
sh_int		gsn_disarm_traps;
sh_int		gsn_boobytrap;
sh_int		gsn_set_traps;
sh_int		gsn_rally;
sh_int		gsn_entwine;
sh_int		gsn_smith;
sh_int		gsn_masterwork;
sh_int		gsn_dismantle;
sh_int		gsn_unholyrite;
sh_int		gsn_eyerub;
sh_int		gsn_fingerbreak;
sh_int		gsn_execute;
sh_int		gsn_earpunch;
sh_int		gsn_brainjar;
sh_int		gsn_rupture;
sh_int		gsn_tonguecut;
sh_int		gsn_cultural_artistry;
sh_int		gsn_stalk;
sh_int		gsn_fire;
sh_int		gsn_smother;
sh_int		gsn_instruct;
sh_int		gsn_tame;
sh_int		gsn_heroic;
sh_int		gsn_evade_spell;
sh_int		gsn_joust;
sh_int		gsn_subdue;
sh_int		gsn_polish;
sh_int		gsn_shield_shatter;
sh_int		gsn_key_origin;
sh_int		gsn_company_might;
sh_int		gsn_company_valor;
sh_int		gsn_company_honor;
sh_int		gsn_arrow_deflection;
sh_int		gsn_preach;
sh_int		gsn_sing;
sh_int		gsn_treeform;
sh_int		gsn_windtalk;
sh_int		gsn_dancing_strike;
sh_int		gsn_point_blank;
sh_int		gsn_wilderness;
sh_int		gsn_bestow_curse;
sh_int		gsn_beastspite;
sh_int		gsn_relegate;
#ifdef LANGUAGES
sh_int 		gsn_lang_elven;
sh_int 		gsn_lang_dwarven;
sh_int 		gsn_lang_drow;
sh_int 		gsn_lang_solamnic;
sh_int 		gsn_lang_draconian;
sh_int 		gsn_lang_common;
sh_int 		gsn_lang_silvanesti;
sh_int 		gsn_lang_qualinesti;
sh_int 		gsn_lang_kagonesti;
sh_int 		gsn_lang_dargonesti;
sh_int 		gsn_lang_dimernesti;
sh_int 		gsn_lang_kender;
sh_int 		gsn_lang_minotaur;
sh_int 		gsn_lang_ogre;
sh_int		gsn_lang_thieves_cant;
#endif
...
void	load_orgs		args( ( void ) );
void  areas_html_update args( ( void ) );
...
void load_songs( void )   /* MGD-S */
{
    FILE *fp;
    SONG_DATA *psonglast;
    if ( ( fp = fopen( SONG_FILE, "r" ) ) == NULL )
        return;  
    ...
    for ( ; ; )
    {
        ...
        ungetc( letter, fp );
        psong           = alloc_perm( sizeof(*psong) );
        if ( str_cmp( fread_word( fp ), "composer" ) )
            break;
        psong->composer   = fread_string( fp );
        if ( str_cmp( fread_word( fp ), "date" ) )
            break;
        psong->date     = fread_string( fp );
        if ( str_cmp( fread_word( fp ), "stamp" ) )
            break;
        psong->date_stamp = fread_number(fp);
        if ( str_cmp( fread_word( fp ), "to" ) )
            break;
        psong->to_list  = fread_string( fp );
        if ( str_cmp( fread_word( fp ), "title" ) )
            break;
        psong->title  = fread_string( fp );
        if ( str_cmp( fread_word( fp ), "recitals" ) )
            break;
        psong->recitals = fread_number(fp);
        if ( str_cmp( fread_word( fp ), "text" ) )
            break;
        psong->text     = fread_string( fp );
        
        if ( song_list == NULL )
            song_list           = psong;
        else
            psonglast->next     = psong;
        psonglast       = psong;
    }
    strcpy( strArea, SONG_FILE );
    fpArea = fp;
    bug( "Load_songs: bad key word.", 0 );
    exit( 1 );
    return;
}
...
void load_area( FILE *fp )
{
    ...
    pArea->continent		= fread_string( fp );
    pArea->control_flags	= fread_number( fp );
    pArea->faction		= fread_number( fp );
    ...
    for ( ; ; )
    {
       ...
       switch ( UPPER(word[0]) )
       {
           case 'N':
            ...
            break;
           case 'S':
		 KEY( "Sector", pArea->sector_type, fread_number(fp) );
		 ...
		 current_area	= pArea;
            ...
            break;
           case 'F':
              KEY( "Faction", pArea->faction, fread_number( fp ) );
		 break;
           case 'B':
	     ...
	     case 'C':
	       ...
	       SKEY( "Continent", pArea->continent );
              KEY( "Controlby", pArea->control_flags, fread_number(fp) );
	       break;
        }
    }
}
...
void load_resets( FILE *fp )
{
	...
	switch( pReset->command )
	{
		...
		switch ( pReset->arg3 )
		{
			...
			case 3: SET_BIT( pexit->rs_flags, EX_CLOSED | EX_MAGICSEAL );
				SET_BIT( pexit->exit_info, EX_CLOSED | EX_MAGICSEAL ); break;
		}
		break;
...
void load_rooms( FILE *fp )
{
	...
	pRoomIndex->sector_type		= fread_number( fp );
        pRoomIndex->light		= 0;
        pRoomIndex->clan_section    = 0; //C054
	...
	for ( ; ; )
	{
		...
		case 2: pexit->exit_info = EX_ISDOOR | EX_PICKPROOF | EX_CLOSED;
			pexit->rs_flags  = EX_ISDOOR | EX_PICKPROOF | EX_CLOSED; break;
		case 3: pexit->exit_info = EX_ISDOOR | EX_NOPASS | EX_CLOSED;    
			pexit->rs_flags  = EX_ISDOOR | EX_NOPASS | EX_CLOSED;    break;
		case 4: pexit->exit_info = EX_ISDOOR | EX_MAGICSEAL |EX_CLOSED;    
			pexit->rs_flags  = EX_ISDOOR | EX_MAGICSEAL | EX_CLOSED;    break;
		case 5: pexit->exit_info = EX_ISDOOR|EX_NOPASS|EX_PICKPROOF|EX_MAGICSEAL|EX_CLOSED;
			pexit->rs_flags  = EX_ISDOOR|EX_NOPASS|EX_PICKPROOF|EX_MAGICSEAL|EX_CLOSED;
			break;
		case 6: pexit->exit_info = EX_ISDOOR | EX_NOPASS | EX_PICKPROOF | EX_CLOSED;    
			pexit->rs_flags  = EX_ISDOOR | EX_NOPASS | EX_PICKPROOF | EX_CLOSED;    break;
		case 7: pexit->exit_info = EX_ISDOOR | EX_MAGICSEAL | EX_PICKPROOF | EX_CLOSED;    
			pexit->rs_flags  = EX_ISDOOR | EX_MAGICSEAL | EX_PICKPROOF | EX_CLOSED;    break;
		case 8: pexit->exit_info = EX_ISDOOR | EX_NOPASS | EX_MAGICSEAL| EX_CLOSED;    
			pexit->rs_flags  = EX_ISDOOR | EX_NOPASS | EX_MAGICSEAL | EX_CLOSED;    break;
		}
...
/* If someone actually wants to FIX the bugs, then fine,
    but I am sick of seeing all of those stupid bugs in
    the logs. Just remove these comments and they will
    bug you again. -- Craig
...
void area_update( void )
{
    ...
    for ( pArea = area_first; pArea != NULL; pArea = pArea->next )
    {
      if(pArea->faction >= 1)
      {
        pArea->control_flags = 1;
      }
	else
      if(pArea->faction <= -1)
      {
        pArea->control_flags = 2;
      }
      else
        pArea->control_flags = 0;
...
CHAR_DATA *create_mobile( MOB_INDEX_DATA *pMobIndex )
{
	...
	mob->steel = number_range(wealth/200,wealth/100);
	mob->gold = wealth - (mob->steel * 100);
    } 
...
void clone_mobile(CHAR_DATA *parent, CHAR_DATA *clone)
{
    ...
    clone->yield		= parent->yield;
    clone->form		= parent->form;
    clone->parts		= parent->parts;
    clone->size		= parent->size;
    clone->material	= str_dup(parent->material);
    clone->org_id		= parent->org_id;
    clone->off_flags	= parent->off_flags;
    clone->dam_type	= parent->dam_type;
    clone->start_pos	= parent->start_pos;
    clone->default_pos	= parent->default_pos;
    clone->spec_fun	= parent->spec_fun;
    clone->fight_pos    = parent->fight_pos;
...
if( material_lookup(pObjIndex->material) == -1 )
    ...
    if( obj->condition != 0 && obj->condition != pObjIndex->condition )
...
/*    sprintf(buf,"Fread_word: word too long.%s",pword);
    bug(buf,0);*/
...
void do_areas( CHAR_DATA *ch, char *argument )
{
    ...
    send_to_char("\n\r",ch);
    send_to_char("{W Num Author      Name of the Zone{x\n\r",ch);
    send_to_char("{y === =========== ========================={x\n\r",ch);

    for ( pArea = area_first; pArea; pArea = pArea->next )
    {
      sprintf( buf,"{C%3d>{x {D%-11s{x {G%-25s{x\n\r",
        pArea->vnum,
        pArea->credits,
	  pArea->name );  
	  add_buf( buffer, buf );
...
void append_file( CHAR_DATA *ch, char *file, char *str )
{
	...
	fgets(name2, MAX_STRING_LENGTH, fp);
	if(name2 == NULL) break;

	name2[strlen(name2)-1] = '\0';
	if(!str_cmp( name2, "</DAYS>")) /* If they are on the roster, skip their name, and do not put */
	...
	send_to_char( "Could not open the file!\n\r", ch );
      ...
      /* below code does the actual appending */
	...
	fprintf( fp, "<LOGGEDBY>%s</LOGGEDBY>\n", ch->name );
	fprintf( fp, "<INROOM>%d</INROOM>\n", ch->in_room ? ch->in_room->vnum : 0 );
	fprintf( fp, "<DISCREPANCY>%s</DISCREPANCY>\n", str );
	fprintf( fp, "</DAY>\n" );
	fprintf( fp, "</DAYS>\n" );
	fclose( fp );
      }
 ...
 * Append a string to a file.
 */
void append_file2( CHAR_DATA *ch, char *file, char *str )
{
    FILE *fp;
