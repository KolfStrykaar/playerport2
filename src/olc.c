...
void do_aedit( CHAR_DATA *ch, char *argument )
{
	...
	{
		send_to_char( "AEdit : Insuffecient security to create new areas.\n\r", ch );
		return;
	}
    ...
    if (!IS_BUILDER(ch,pArea))
    {
	send_to_char("Insuffecient security to edit this area.\n\r",ch);
	return;
    }
...
void do_redit( CHAR_DATA *ch, char *argument )
{
	...
	{
		send_to_char( "Insuffecient security to edit this room.\n\r" , ch );
        	return;
	}
	...
	if ( !IS_BUILDER(ch, pRoom->area) )
	{
		send_to_char( "REdit : Insuffecient security to edit this room.\n\r", ch );
		return;
	}
...
void do_oedit( CHAR_DATA *ch, char *argument )
{
	...
	if ( !( pObj = get_obj_index( value ) ) )
	{
	  ...
	  return;
        ...
        &&   (ch->level != 110))
	{
	  send_to_char( "OEdit: You are NOT authorized to edit this Object.\n\r",ch );
	  return;
	}

	if ( !IS_BUILDER( ch, pObj->area ) )
	{
          send_to_char( "Insuffecient security to edit objects in this area.\n\r",ch );
	  return;
	}
...
void do_medit( CHAR_DATA *ch, char *argument )
{
	...
	{
		send_to_char( "Insuffecient security to edit mobs in this area.\n\r" , ch );
	        return;
	}
	  ...
	  || (!str_cmp( arg2, "obj" ) && is_number( arg3 )) )
	{
		...
		if ( !str_cmp( arg4, "room" ) )
		{
		    if (get_obj_index(atoi(arg3)) == NULL)
		      {
		         send_to_char( "Vnum non existant.\n\r",ch);
		         return;
		      }
		    pReset->command  = 'O';
		    pReset->arg2     = 0;
