...
void do_sedit (CHAR_DATA *ch, char *argument)
{
  ...
  else if (!str_cmp(cmd, "name")) /* change the name of the social */
  {
    ...
    old_name = social;
    free_string (social_table[iSocial].name);
    strcpy(social_table[iSocial].name, str_dup (argument));		

    printf_to_char (ch,"\n\rSocial has been changed from: %s to %s\n\r", old_name, argument);
  }
