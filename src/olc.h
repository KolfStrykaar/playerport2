...
DECLARE_OLC_FUN( aedit_continent	); /* LOK */
DECLARE_OLC_FUN( aedit_control	); /* LOK */
DECLARE_OLC_FUN( aedit_sector		); /* LOK */
DECLARE_OLC_FUN( aedit_vnum		);
DECLARE_OLC_FUN( aedit_lvnum		);
DECLARE_OLC_FUN( aedit_uvnum		);
DECLARE_OLC_FUN( aedit_credits	);
/*
 * Autoarmor/Autoweapon
 */
...
DECLARE_OLC_FUN( medit_autoset	);  /* LoK */
...
void		show_traplist		args ( ( CHAR_DATA *ch ) );
